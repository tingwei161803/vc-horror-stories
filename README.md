...
2026 年 6 月,一條在 X(Twitter)上爆紅的串文變成了一場集體告解:創辦人(其中不乏億萬富翁)輪流講出創投界最不堪的時刻 —— 當場睡著的合夥人、因性別而被拒絕的募資、想在晚餐桌上拆散創始團隊的提議。本站把這些故事整理成一頁式的雙語檔案,並用「深色驚悚編輯風」呈現。內容來源為創辦人公開貼文截圖(由 Grok 翻譯為繁中)與 TechCrunch 的報導。
...
- 🏷️ **主題篩選** — 故事可依「恐怖類型」(睡著 / 傲慢 / 偏見 / 荒謬 / 權力 / 越界)即時篩選,並顯示結果數。
...
1. **主要來源**:創辦人於 **X(Twitter)** 公開分享的貼文截圖,由 Grok 翻譯為繁體中文(原始截圖存於本機 `sources/`,**未隨網站發佈**)。
   涉及的創辦人包含:Matthew Prince(Cloudflare)、Greg Isenberg、Liz Wessel、Todd Jackson、Mark Cummins、Isaiah Taylor、dax(@thdxr)等。
2. **佐證來源**:TechCrunch,〈Founders share VC horror stories, and some are naming names〉,作者 Julie Bort,2026-06-05。
   用以補齊 Mark Pincus(Zynga)、Travis Kalanick(Uber)、Julie Fredrickson(Chaotic Capital)等未截圖的故事與背景。
